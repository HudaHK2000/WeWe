                ...
                <div class="shortcode_modules">
                    ...
                    <div class="modules__content">
                        <div class="panel-group accordion " role="tablist" id="accordion">
                                <!-- earthquake -->
                                <div class="panel accordion__single accordion-bgcolor col-12 " id="panel-one">
                                ...
                                <!-- floods -->
                                <div class="panel accordion__single accordion-bgcolor col-12 " id="panel-two">
                                    <div class="single_acco_title">
                                        <h4>
                                            <a data-toggle="collapse" href="#collapse2" class="collapsed" aria-expanded="false" data-target="#collapse2" aria-controls="collapse2">
                                                <img src="{{ asset('images/svg/Flood.svg')}}" alt="" style="max-width:16%;margin-right: 10px;">
                                ...
                                <!-- end /.accordion__single -->
                                <!-- heat waves -->
                                <div class="panel accordion__single accordion-bgcolor col-12 " id="panel-three">
                                    <div class="single_acco_title">
                                        <h4>
                                            <a data-toggle="collapse" href="#collapse3" class="collapsed" aria-expanded="false" data-target="#collapse3" aria-controls="collapse3">
                                                <img src="{{ asset('images/svg/heat waves.svg')}}" alt="" style="max-width:9%;margin-right: 10px; margin-left: 15px;">
                                ...
                                <!-- end /.accordion__single -->
                                <!-- fires -->
                                <div class="panel accordion__single accordion-bgcolor col-12 " id="panel-four">
                                    <div class="single_acco_title">
                                        <h4>
                                            <a data-toggle="collapse" href="#collapse4" class="collapsed" aria-expanded="false" data-target="#collapse4" aria-controls="collapse4">
                                                <img src="{{ asset('images/svg/fires.svg')}}" alt="" style="max-width:12%;margin-right: 10px;">

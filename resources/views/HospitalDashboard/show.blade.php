...
<a href='{{ url("/hospital/{$hospital->id}/show") }}'>Show</a>
@endsection
...
@endif
{{-- update hospital  --}}
<form class="setting_form" method="POST" action='{{ url("hospital/{$hospital->id}/update") }}' enctype="multipart/form-data">
    @csrf
    {{method_field('POST')}}
    <div class="row">
        {{-- information --}}
